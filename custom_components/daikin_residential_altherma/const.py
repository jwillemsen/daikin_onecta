...
ATTR_TANK_TARGET_TEMPERATURE = "DHWTargetTemperature"
...
DAIKIN_CMD_SETS = {
    ...
    ATTR_TANK_TARGET_TEMPERATURE: [MP_DHW_TANK, DP_DHW_TEMPERATURE, "/operationModes/heating/setpoints/domesticHotWaterTemperature"],
    #  Gateway settings
...
ATTR_STATE_ON = "on"
ATTR_STATE_OFF = "off"
SWITCH_DHW_TANK_ONOFF = "onOffMode"
SWITCH_POWERFUL_ONOFF = "powerfulMode"

PRESET_BOOST= "boost"
PRESET_TANK_ONOFF= "Tank"
PRESET_SETPOINT_MODE = "setpointMode"
DAIKIN_SWITCHES = [PRESET_BOOST,PRESET_TANK_ONOFF] #PRESET_SETPOINT_MODE ,SWITCH_DHW_TANK_ONOFF,SWITCH_POWERFUL_ONOFF,
